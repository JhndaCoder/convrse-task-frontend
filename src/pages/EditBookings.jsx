    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            ...
            if (status.toLowerCase() === 'pending' || status.toLowerCase() === 'confirmed') {
                const userResponse = await customFetch.get(`/api/auth/email/${customerEmail}`);
            ...
            await customFetch.put(`/api/bookings/update-status/${editingBooking._id}`, payload);
                ...
                {editingBooking && (
                    <div className="property-form-container">
                        ...
                        <form onSubmit={handleFormSubmit} className="property-form">
                            ...
                            <p>Booking Date: {new Date(editingBooking.bookingDate).toLocaleDateString()}</p>
                ...
                <div className="property-grid">
                    {filteredBookings.map((booking) => (
                        <div key={booking._id} className="admin-property-card">
                            ...
                            <button onClick={() => startEditing(booking)} className="update-button">
                                Edit Booking
                            </button>
